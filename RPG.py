...
def initBattle():
    ...
    try:
                ...
                while True:
                    try:
                        ...
                        for i in range(10, len(myitems) + 10):
                            print(" " + str(myitems[i - 10]["name"]) + " (inventory: " + str(
                                myitemcount[i - 10]) + "): " + str(i))
                        x = len(myitems)
                        n = int(input(" command: "))
                        if n < 10 + x and n > 0:
                            break
            ...
            if myStun == 0:
                for i in activeSkillsInfo:
                    ...
                    if i["spellID"]["self_dmg"] > 0:
                        ...
                        print("You hit yourself with the " + str(i["spellID"]['name']) + " and lost " + str(
                            i["spellID"]["self_dmg"]) + " health points")
                        time.sleep(2)
            if enHP < 0:
                print("\nYou won!")
            ...
            if enStun == 0:
                ...
                for i in enactiveSkillsInfo:
                    ...
                    if i["spellID"]["self_dmg"] > 0:
                        ...
                        print("Enemy hit himself with the " + str(i["spellID"]['name']) + " and lost " + str(
                            i["spellID"]["self_dmg"]) + " health points")
                        time.sleep(2)
        ...
        print("You ran out of ram and the game crashed")
...
while(end):
    ...
    if command.startswith("instructions"):
        print("\n ===Instructions=== \n")
        print(" The aim of this game is to defeat the enemy")
        print("\n You start with 1000 coins and can decide which armour or items you want to buy")
        print("\n There are 4 weapons you can choose from (weapon skills need skill points to activate)")
        print(" Each weapon has its own set of skills")
        print(" You are able to choose 2 weapons to use during battle")
        print("\n Next you can choose your basic skills (basic skill do not use any skill points)")
        print(" There are 6 skills you can choose from")
        print(" You can choose 3 skills to use during battle")
